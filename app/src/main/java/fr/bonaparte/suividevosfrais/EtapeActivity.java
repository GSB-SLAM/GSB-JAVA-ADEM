...
public class EtapeActivity extends Activity {
	...
	private void imgReturn_clic() {
		findViewById(R.id.imgGSB).setOnClickListener(new ImageView.OnClickListener() {
    ...
    private void cmdValider_clic() {
    	((Button)findViewById(R.id.cmdReportValider)).setOnClickListener(new Button.OnClickListener() {
    		public void onClick(View v) {
